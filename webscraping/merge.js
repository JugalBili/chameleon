...
import { getFirestore, connectFirestoreEmulator, writeBatch, doc } from "firebase/firestore";
const credentials = JSON.parse(
    await readFile(
        new URL("./firebase-auth.json", import.meta.url)
    )
)
...
const files = ["./benjaminMoore.json", "ppg.json"]
// const files = ["./test.js"]
