...
class GalleryService:
    ...
    async def upload_image(self, user: User, file: UploadFile, image_data: UploadReviewImageDTO):
        ...
        return await self.repository.upload_review_image(user, file, image_data.paint_id)
